...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>NotModified</code>.
  ...
  /**
   * Constructs a <code>NotModified</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotModified} obj Optional instance to populate.
   * @return {module:model/NotModified} The populated <code>NotModified</code> instance.
   */
